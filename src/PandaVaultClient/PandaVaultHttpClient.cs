...
/// <summary>Fetches configuration entries from the PandaVault service over HTTP.</summary>
public static class PandaVaultHttpClient
{
    /// <summary>
    ///     Fetch all configurations from PandaVault using the PANDAVAULT_URL and PANDAVAULT_SECRET
    ///     environment variables. Returns an empty list when the secret is invalid or none are set.
    /// </summary>
